...
def main():
  ...
  plistpath = scriptpath + "/resources/Sputter-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Sputter-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Sputter-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Sputter-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Sputter-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Sputter.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Sputter.iss",inplace=1):
