...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Sputter Demo Installer\n"
      else:
        line="OutputBaseFilename=Sputter Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Sputter Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Sputter installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Sputter Demo installer\n"
     else:
       line="SetupWindowTitle=Sputter installer\n"
